...
//            HttpServletRequest request
    ...
    ) { // 나가고자하는 멤버의 인증정보를 가진 request
        log.info("방 나가기 - 방 아이디 : {}, uuid(유저아이디) : {}", roomId, stringDto.getValue());
        return gameRoomService.roomExit(roomId, stringDto);
    }
